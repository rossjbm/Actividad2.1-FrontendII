    ...
    return (<div className='flex justify-center'>
        <Form className='p-3 my-20 bg-orange-200 rounded sm:w-5/6 lg:w-3/5'>
            ...
            <Form.Group>
                ...
                <span className='cursor-pointer flex justify-center m-4' onClick={(e)=>{e.preventDefault(), setFormInicio(false)}}>¿Aún no te has Registrado?  <span className='cursor-pointer hover:text-orange-500' onClick={(e)=>{e.preventDefault(), setFormInicio(false)}}>  Regístrate ya</span></span>
            <Form.Group className='flex justify-center mb-6 mt-10' >
                <Button type="submit" onClick={enviar} style={{background:'#212226', border:'none'}} className='pb-4 rounded w-24 h-10 text-xl'>Iniciar</Button>
            </Form.Group>
        </Form>
    </div>)
}